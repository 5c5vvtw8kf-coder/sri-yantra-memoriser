...
const CONTENT = {
  en: {
    ...
    how2: 'Work through the Explore and Memorise section level by level. Explore mode is there to review the content and Memorise mode to recall the focus object in your mind before hovering over it to reveal the deity and recording whether it is memorised or not, by clicking or double-clicking respectively. Then further test your recall with the random Location Match and Spot Check features. The Memory Map exists to map out your strengths and weaknesses and where to focus further efforts.',
    how_drills: "Segment Drills test recall within a single wedge of the yantra, Line Drills test recall along a line that cuts across several circuits, and Triangle Drills test recall within one of the yantra's nine foundational construction triangles. All three are worth trying once a section feels solid in Explore and Memorise mode.",
    how_sync: 'If you use more than one device, e.g. desktop, laptop, mobile or iPad etc. the Device Sync section (at the bottom of the left menu panel) lets you sync your progress between them with a short code. No account, email, or password is required.',
  ...
  'en-us': {
    ...
    how2: 'Work through the Explore and Memorize section level by level. Explore mode is there to review the content and Memorize mode to recall the focus object in your mind before hovering over it to reveal the deity and recording whether it is memorized or not, by clicking or double-clicking respectively. Then further test your recall with the random Location Match and Spot Check features. The Memory Map exists to map out your strengths and weaknesses and where to focus further efforts.',
    how_drills: "Segment Drills test recall within a single wedge of the yantra, Line Drills test recall along a line that cuts across several circuits, and Triangle Drills test recall within one of the yantra's nine foundational construction triangles. All three are worth trying once a section feels solid in Explore and Memorize mode.",
    how_sync: 'If you use more than one device, e.g. desktop, laptop, mobile or iPad etc. the Device Sync section (at the bottom of the left menu panel) lets you sync your progress between them with a short code. No account, email, or password is required.',
  ...
  hi: {
    ...
    how2: 'अन्वेषण और कंठस्थ अनुभाग में स्तर-दर-स्तर कार्य करें। अन्वेषण मोड सामग्री की समीक्षा के लिए है और कंठस्थ मोड में आप देवता के नाम को मन में स्मरण करें और फिर प्रकट करें — सही होने पर क्लिक और गलत होने पर डबल-क्लिक करें। Location Match और स्पॉट चेक से यादृच्छिक पुनरावृत्ति करें। स्मृति मानचित्र आपकी शक्तियों और कमजोरियों को प्रदर्शित करता है।',
    how_drills: 'सेगमेंट ड्रिल श्री यन्त्र के एक खंड के भीतर स्मरण-शक्ति की जाँच करता है, लाइन ड्रिल कई आवरणों को पार करने वाली एक रेखा के साथ स्मरण-शक्ति की जाँच करता है, और त्रिकोण ड्रिल यन्त्र के नौ मूल रचनात्मक त्रिकोणों में से एक के भीतर स्मरण-शक्ति की जाँच करता है। जब कोई अनुभाग अन्वेषण और कंठस्थ मोड में सुदृढ़ लगे, तब तीनों आज़माने योग्य हैं।',
    how_sync: 'यदि आप एक से अधिक उपकरणों पर उपयोग करते हैं, तो बाईं ओर के पैनल के सबसे नीचे स्थित डिवाइस सिंक विभाग एक छोटे कोड की सहायता से आपकी प्रगति को उनके बीच ले जाने देता है — किसी खाते, ईमेल या पासवर्ड की आवश्यकता नहीं।',
  ...
  kn: {
    ...
    how2: 'ಅನ್ವೇಷಣ ಮತ್ತು ಕಂಠಸ್ಥ ವಿಭಾಗವನ್ನು ಹಂತ ಹಂತವಾಗಿ ಕೆಲಸ ಮಾಡಿ. ಅನ್ವೇಷಣ ಮೋಡ್ ಪರಿಶೀಲನೆಗೆ, ಕಂಠಸ್ಥ ಮೋಡ್‌ನಲ್ಲಿ ಮನಸ್ಸಿನಲ್ಲಿ ಸ್ಮರಿಸಿ ನಂತರ ದೇವತೆ ಹೆಸರು ಬಹಿರಂಗಪಡಿಸಿ — ಸರಿ ಇದ್ದರೆ ಕ್ಲಿಕ್, ತಪ್ಪಾದರೆ ಡಬಲ್-ಕ್ಲಿಕ್. Location Match ಮತ್ತು ಸ್ಪಾಟ್ ಚೆಕ್ ಯಾದೃಚ್ಛಿಕ ಪುನರಾವರ್ತನೆ ಒದಗಿಸುತ್ತವೆ. ಸ್ಮೃತಿ ಪಟ ನಿಮ್ಮ ಶಕ್ತಿ ಮತ್ತು ದೌರ್ಬಲ್ಯಗಳನ್ನು ತೋರಿಸುತ್ತದೆ.',
    how_drills: 'ಸೆಗ್ಮೆಂಟ್ ಡ್ರಿಲ್ ಯಂತ್ರದ ಒಂದು ವಿಭಾಗದೊಳಗೆ ನೆನಪನ್ನು ಪರೀಕ್ಷಿಸುತ್ತದೆ, ಲೈನ್ ಡ್ರಿಲ್ ಹಲವಾರು ಆವರಣಗಳನ್ನು ದಾಟುವ ಗೆರೆಯ ಉದ್ದಕ್ಕೂ ನೆನಪನ್ನು ಪರೀಕ್ಷಿಸುತ್ತದೆ, ಮತ್ತು ತ್ರಿಕೋನ ಡ್ರಿಲ್ ಯಂತ್ರದ ಒಂಬತ್ತು ಮೂಲ ರಚನಾ ತ್ರಿಕೋನಗಳಲ್ಲಿ ಒಂದರೊಳಗೆ ನೆನಪನ್ನು ಪರೀಕ್ಷಿಸುತ್ತದೆ. ಒಂದು ವಿಭಾಗ ಅನ್ವೇಷಣ ಮತ್ತು ಕಂಠಸ್ಥ ಮೋಡ್‌ನಲ್ಲಿ ಭದ್ರವೆನಿಸಿದಾಗ ಮೂರನ್ನೂ ಪ್ರಯತ್ನಿಸಬಹುದು.',
    how_sync: 'ನೀವು ಒಂದಕ್ಕಿಂತ ಹೆಚ್ಚು ಸಾಧನಗಳಲ್ಲಿ ಬಳಸಿದರೆ, ಎಡ ಫಲಕದ ಕೆಳಭಾಗದಲ್ಲಿರುವ ಡಿವೈಸ್ ಸಿಂಕ್ ವಿಭಾಗವು ಒಂದು ಚಿಕ್ಕ ಕೋಡ್ ಮೂಲಕ ನಿಮ್ಮ ಪ್ರಗತಿಯನ್ನು ಅವುಗಳ ನಡುವೆ ಸಾಗಿಸಲು ಅನುಮತಿಸುತ್ತದೆ — ಖಾತೆ, ಇಮೇಲ್ ಅಥವಾ ಪಾಸ್‌ವರ್ಡ್ ಅಗತ್ಯವಿಲ್ಲ.',
  ...
  ml: {
    ...
    how2: 'പര്യവേഷണ-മനഃപ്പാഠ വിഭാഗം ഘട്ടം ഘട്ടമായി ചെയ്യുക. പര്യവേഷണ മോഡ് ഉള്ളടക്കം അവലോകനത്തിന്, മനഃപ്പാഠ മോഡിൽ ദേവതാ നാമം മനസ്സിൽ ഓർക്കുക, പിന്നെ വെളിപ്പെടുത്തുക — ശരിയാണെങ്കിൽ ക്ലിക്ക്, തെറ്റാണെങ്കിൽ ഡബ്ൾ-ക്ലിക്ക്. Location Matchഉം സ്പോട്ട് ചെക്കും ക്രമരഹിത ആവർത്തനം നൽകുന്നു. ഓർമ്മ മാപ്പ് നിങ്ങളുടെ ശക്തിഭേദങ്ങൾ കാണിക്കുന്നു.',
    how_drills: 'സെഗ്മെന്റ് ഡ്രിൽ യന്ത്രത്തിന്റെ ഒരു ഭാഗത്തിനുള്ളിൽ ഓർമ്മ പരിശോധിക്കുന്നു, ലൈൻ ഡ്രിൽ പല ആവരണങ്ങളും മുറിച്ചുകടക്കുന്ന ഒരു രേഖയിലൂടെ ഓർമ്മ പരിശോധിക്കുന്നു, ത്രികോണ ഡ്രിൽ യന്ത്രത്തിന്റെ ഒൻപത് അടിസ്ഥാന നിർമ്മാണ ത്രികോണങ്ങളിൽ ഒന്നിനുള്ളിൽ ഓർമ്മ പരിശോധിക്കുന്നു. ഒരു വിഭാഗം പര്യവേഷണ, മനഃപ്പാഠ മോഡിൽ ഉറച്ചതായി തോന്നുമ്പോൾ മൂന്നും പരീക്ഷിക്കാവുന്നതാണ്.',
    how_sync: 'നിങ്ങൾ ഒന്നിലധികം ഉപകരണങ്ങൾ ഉപയോഗിക്കുകയാണെങ്കിൽ, ഇടത് പാനലിന്റെ താഴെയുള്ള ഡിവൈസ് സിങ്ക് വിഭാഗം ഒരു ചെറിയ കോഡ് ഉപയോഗിച്ച് നിങ്ങളുടെ പുരോഗതി അവയ്ക്കിടയിൽ കൊണ്ടുപോകാൻ അനുവദിക്കുന്നു — അക്കൗണ്ട്, ഇമെയിൽ അല്ലെങ്കിൽ പാസ്‌വേഡ് ആവശ്യമില്ല.',
  ...
  ta: {
    ...
    how2: 'ஆராய்ந்து மனப்பாடம் செய்யும் பிரிவில் நிலை நிலையாக செயல்படுங்கள். ஆராய்வு முறை உள்ளடக்க மதிப்பாய்வுக்கும், மனப்பாட முறையில் தேவதை பெயரை மனதில் நினைத்துப் பார்த்து வெளிப்படுத்துங்கள் — சரியெனில் கிளிக், தவறெனில் இருமுறை கிளிக். Location Match மற்றும் ஸ்பாட் செக் தோராயமான மதிப்பாய்வை வழங்குகின்றன. நினைவு வரைபடம் உங்கள் வலிமை மற்றும் பலவீனங்களை காட்டுகிறது.',
    how_drills: 'செக்மென்ட் டிரில் யந்த்ரத்தின் ஒரு பிரிவுக்குள் நினைவை சோதிக்கிறது, லைன் டிரில் பல ஆவரணங்களைக் கடக்கும் ஒரு கோட்டின் வழியே நினைவை சோதிக்கிறது, மற்றும் முக்கோண டிரில் யந்த்ரத்தின் ஒன்பது அடிப்படை கட்டமைப்பு முக்கோணங்களில் ஒன்றுக்குள் நினைவை சோதிக்கிறது. ஒரு பிரிவு ஆராய்வு மற்றும் மனப்பாட முறையில் உறுதியாக உணரும்போது மூன்றையும் முயற்சிக்கலாம்.',
    how_sync: 'நீங்கள் ஒன்றுக்கு மேற்பட்ட சாதனங்களில் பயன்படுத்தினால், இடது பலகத்தின் அடிப்பகுதியில் உள்ள சாதன ஒத்திசைவு பிரிவு ஒரு குறுங்குறியீட்டின் மூலம் உங்கள் முன்னேற்றத்தை அவற்றுக்கிடையே கொண்டு செல்ல அனுமதிக்கிறது — கணக்கு, மின்னஞ்சல் அல்லது கடவுச்சொல் தேவையில்லை.',
  ...
  te: {
    ...
    how2: 'అన్వేషణ మరియు కంఠస్థం విభాగంలో స్థాయి స్థాయిగా పని చేయండి. అన్వేషణ మోడ్ సమీక్షకు, కంఠస్థం మోడ్‌లో దేవతా నామం మనసులో స్మరించి బహిర్గతం చేయండి — సరైతే క్లిక్, తప్పైతే డబుల్-క్లిక్. Location Match మరియు స్పాట్ చెక్ యాదృచ్ఛిక పునరావృత్తిని అందిస్తాయి. జ్ఞాపక పటం మీ బలాలు మరియు బలహీనతలు చూపిస్తుంది.',
    how_drills: 'సెగ్మెంట్ డ్రిల్ యంత్రంలోని ఒక విభాగంలో జ్ఞాపకశక్తిని పరీక్షిస్తుంది, లైన్ డ్రిల్ అనేక ఆవరణలను దాటే లైన్ వెంట జ్ఞాపకశక్తిని పరీక్షిస్తుంది, మరియు త్రికోణ డ్రిల్ యంత్రంలోని తొమ్మిది మూల నిర్మాణ త్రికోణాలలో ఒకదానిలో జ్ఞాపకశక్తిని పరీక్షిస్తుంది. ఒక విభాగం అన్వేషణ మరియు కంఠస్థం మోడ్‌లో స్థిరంగా అనిపించినప్పుడు మూడూ ప్రయత్నించదగినవి.',
    how_sync: 'మీరు ఒకటి కంటే ఎక్కువ పరికరాలలో ఉపయోగిస్తే, ఎడమ ప్యానెల్ దిగువన ఉన్న డివైస్ సింక్ విభాగం ఒక చిన్న కోడ్ ద్వారా మీ పురోగతిని వాటి మధ్య తీసుకెళ్లడానికి అనుమతిస్తుంది — ఖాతా, ఇమెయిల్ లేదా పాస్‌వర్డ్ అవసరం లేదు.',
  ...
  mr: {
    ...
    how2: 'अन्वेषण आणि पाठ विभागात स्तर-दर-स्तर कार्य करा. अन्वेषण मोड सामग्रीच्या आढाव्यासाठी आहे आणि पाठ मोडमध्ये देवतेचे नाव मनात आठवा, नंतर प्रकट करा — बरोबर असल्यास क्लिक, चुकीचे असल्यास दुहेरी-क्लिक. Location Match आणि स्पॉट चेक यादृच्छिक पुनरावृत्ती देतात. स्मृती नकाशा तुमची बलस्थाने आणि कमकुवत बाजू दाखवतो.',
    how_drills: 'सेगमेंट ड्रिल यंत्राच्या एका विभागातील स्मरणशक्ती तपासते, लाइन ड्रिल अनेक आवरणे ओलांडणाऱ्या एका रेषेवरील स्मरणशक्ती तपासते, आणि त्रिकोण ड्रिल यंत्राच्या नऊ मूळ रचनात्मक त्रिकोणांपैकी एकामधील स्मरणशक्ती तपासते. एखादा विभाग अन्वेषण आणि पाठ मोडमध्ये पक्का वाटू लागल्यावर तिन्ही करून पाहण्यासारखे आहेत.',
    how_sync: 'तुम्ही एकापेक्षा जास्त उपकरणांवर वापरत असल्यास, डाव्या पॅनेलच्या तळाशी असलेला डिव्हाइस सिंक विभाग एका लहान कोडद्वारे तुमची प्रगती त्यांच्यामध्ये नेण्याची सुविधा देतो — खाते, ईमेल किंवा पासवर्डची आवश्यकता नाही.',
  ...
  gu: {
    ...
    how2: 'અન્વેષણ અને કંઠસ્થ વિભાગમાં સ્તર-દર-સ્તર કાર્ય કરો. અન્વેષણ મોડ સામગ્રી સમીક્ષા માટે છે અને કંઠસ્થ મોડમાં દેવતાનું નામ મનમાં યાદ કરો અને પછી પ્રકટ કરો — સાચું હોય તો ક્લિક, ખોટું હોય તો ડબલ-ક્લિક. Location Match અને સ્પૉટ ચેક યાદ્રચ્છિક પુનરાવર્તન આપે છે. સ્મૃતિ નકશો આપની શક્તિ અને દુર્બળાઇઓ દર્શાવે છે.',
    how_drills: 'સેગમેન્ટ ડ્રિલ યન્ત્રના એક ખંડમાં સ્મરણશક્તિ ચકાસે છે, લાઇન ડ્રિલ અનેક આવરણોને ઓળંગતી એક રેખા પર સ્મરણશક્તિ ચકાસે છે, અને ત્રિકોણ ડ્રિલ યન્ત્રના નવ મૂળભૂત રચનાત્મક ત્રિકોણોમાંથી એકમાં સ્મરણશક્તિ ચકાસે છે. કોઈ વિભાગ અન્વેષણ અને કંઠસ્થ મોડમાં મજબૂત લાગે ત્યારે ત્રણેય અજમાવવા યોગ્ય છે.',
    how_sync: 'જો તમે એકથી વધુ ઉપકરણો પર ઉપયોગ કરો છો, તો ડાબા પેનલના તળિયે આવેલો ડિવાઇસ સિંક વિભાગ એક ટૂંકા કોડ દ્વારા તમારી પ્રગતિ તેમની વચ્ચે લઈ જવા દે છે — ખાતું, ઇમેઇલ અથવા પાસવર્ડની જરૂર નથી.',
  ...
  fr: {
    ...
    how2: "Parcourez les sections Explorer et Mémoriser niveau par niveau. Le mode Explorer permet de réviser le contenu, tandis que le mode Mémoriser invite à rappeler mentalement la divinité avant de survoler pour la révéler, puis d'enregistrer si elle est mémorisée ou non par un clic ou double-clic. Testez ensuite votre mémorisation avec les fonctions aléatoires Location Match et Contrôle Rapide. La Carte Mémoire permet de visualiser vos points forts et vos lacunes.",
    how_drills: "Les Exercices de Segment testent la mémorisation au sein d'un seul segment du yantra, les Exercices de Ligne la testent le long d'une ligne traversant plusieurs cercles, et les Exercices de Triangle la testent au sein de l'un des neuf triangles fondamentaux de construction du yantra. Les trois sont utiles une fois qu'une section semble bien maîtrisée en mode Explorer et Mémoriser.",
    how_sync: "Si vous utilisez plusieurs appareils, la section Synchronisation des appareils (en bas du panneau de gauche) vous permet de transférer votre progression entre eux à l'aide d'un court code — aucun compte, e-mail ou mot de passe requis.",
  ...
  es: {
    ...
    stotram: "El Khadgamalā o 'Collar de Espadas' Stotram, invoca por nombre a las deidades que residen en cada una de las nueve āvaraṇas, avanzando desde el Bhūpura más exterior hacia adentro, con creciente secreto, hasta el Bindu. Las nueve āvaraṇas contienen 102 nombres de deidades. El stotram completo también incluye los Nyāsa Devatāḥ, los Tithi Nitya Devatāḥ, los gurús Divyaugha, Siddhaugha y Mānavaugha, los Nava Cakreśvarī, y epítetos finales — alrededor de 160 nombres en total, variando ligeramente según el linaje. Recitar el stotram completo con el Śrī Yantra claramente en mente se considera equivalente a una pūjā del Śrī Cakra.",
    ...
    how2: 'Trabaja las secciones de Explorar y Memorizar nivel por nivel. El modo Explorar sirve para revisar el contenido y el modo Memorizar para recordar la deidad en tu mente antes de revelarla pasando el cursor, registrando si está memorizada o no con un clic o doble clic. Luego comprueba tu memorización con las funciones aleatorias de Location Match y Comprobación Rápida. El Mapa de Memoria permite visualizar tus fortalezas y debilidades.',
    how_drills: 'Los Ejercicios de Segmento comprueban la memorización dentro de un único segmento del yantra, los Ejercicios de Línea la comprueban a lo largo de una línea que atraviesa varios círculos, y los Ejercicios de Triángulo la comprueban dentro de uno de los nueve triángulos fundamentales de construcción del yantra. Los tres son útiles una vez que una sección se sienta sólida en el modo Explorar y Memorizar.',
    how_sync: 'Si usas varios dispositivos, la sección Sincronización de dispositivos (al final del panel izquierdo) te permite llevar tu progreso entre ellos mediante un código corto — no se necesita cuenta, correo electrónico ni contraseña.',
  ...
  it: {
    ...
    how2: "Lavora le sezioni Esplora e Memorizza livello per livello. La modalità Esplora serve per ripassare il contenuto, mentre la modalità Memorizza invita a richiamare mentalmente la divinità prima di rivelare il nome passando il cursore, registrando se è memorizzata o meno con un clic o doppio clic. Poi metti alla prova la tua memorizzazione con le funzioni casuali Location Match e Controllo Rapido. La Mappa della Memoria permette di visualizzare i tuoi punti di forza e di debolezza.",
    how_drills: "Gli Esercizi di Segmento verificano la memorizzazione all'interno di un singolo segmento dello yantra, gli Esercizi di Linea la verificano lungo una linea che attraversa più cerchi, e gli Esercizi di Triangolo la verificano all'interno di uno dei nove triangoli fondamentali di costruzione dello yantra. Tutti e tre sono utili una volta che una sezione appare solida in modalità Esplora e Memorizza.",
    how_sync: "Se usi più dispositivi, la sezione Sincronizzazione dispositivi (in fondo al pannello sinistro) ti permette di portare i tuoi progressi tra loro tramite un codice breve — nessun account, e-mail o password richiesti.",
  ...
  pt: {
    ...
    stotram: "O Khadgamalā ou 'Colar de Espadas' Stotram, invoca pelo nome as divindades que residem em cada uma das nove āvaraṇas, avançando desde o Bhūpura mais externo para o interior, com crescente sigilo, até ao Bindu. As nove āvaraṇas contêm 102 nomes de divindades. O stotram completo inclui também os Nyāsa Devatāḥ, os Tithi Nitya Devatāḥ, os gurus Divyaugha, Siddhaugha e Mānavaugha, os Nava Cakreśvarī, e epítetos finais — cerca de 160 nomes no total, variando ligeiramente consoante a linhagem. Recitar o stotram completo com o Śrī Yantra claramente em mente é considerado equivalente a uma pūjā do Śrī Cakra.",
    ...
    how2: 'Trabalhe as secções de Explorar e Memorizar nível a nível. O modo Explorar serve para rever o conteúdo e o modo Memorizar convida a recordar mentalmente a divindade antes de revelar o nome passando o cursor, registando se está memorizada ou não com um clique ou duplo clique. Depois teste a sua memorização com as funções aleatórias de Location Match e Verificação Rápida. O Mapa de Memória permite visualizar os seus pontos fortes e fracos.',
    how_drills: 'Os Exercícios de Segmento testam a memorização dentro de um único segmento do yantra, os Exercícios de Linha testam-na ao longo de uma linha que atravessa vários círculos, e os Exercícios de Triângulo testam-na dentro de um dos nove triângulos fundamentais de construção do yantra. Os três são úteis quando uma secção já parece sólida no modo Explorar e Memorizar.',
    how_sync: 'Se usa vários dispositivos, a secção Sincronização de dispositivos (na parte inferior do painel esquerdo) permite transferir o seu progresso entre eles através de um código curto — não é necessária conta, e-mail nem palavra-passe.',
  ...
  de: {
    ...
    how2: 'Arbeite die Abschnitte Erkunden und Einprägen Ebene für Ebene durch. Der Erkunden-Modus dient zur Wiederholung des Inhalts, während der Einprägen-Modus dazu einlädt, die Gottheit gedanklich zu erinnern, bevor man über sie fährt, um sie zu enthüllen, und dann durch Klick oder Doppelklick festzuhalten, ob sie eingeprägt wurde. Teste deine Memorierung anschließend mit den zufälligen Funktionen Location Match und Schnelltest. Die Gedächtniskarte zeigt deine Stärken und Schwächen.',
    how_drills: 'Segmentübungen prüfen das Erinnerungsvermögen innerhalb eines einzelnen Segments des Yantra, Linienübungen prüfen es entlang einer Linie, die mehrere Kreise durchquert, und Dreiecksübungen prüfen es innerhalb eines der neun grundlegenden Konstruktionsdreiecke des Yantra. Alle drei lohnen sich, sobald ein Abschnitt im Erkunden- und Einprägen-Modus sicher sitzt.',
    how_sync: 'Wenn du mehrere Geräte nutzt, kannst du im Abschnitt Geräte-Synchronisierung (unten im linken Bereich) deinen Fortschritt per kurzem Code zwischen ihnen übertragen — kein Konto, keine E-Mail, kein Passwort erforderlich.',
  ...
  ru: {
    mantra: 'Oṃ Aiṃ Hrīṃ Śrīṃ Aiṃ Klīṃ Sauḥ',
    salut:  'Намастрипурасундари',
    fontClass: 'iast',
    welcome1: 'Намаскарам и добро пожаловать в Śrī Yantra Memoriser — инструмент для изучения и усвоения Кхадгамала Стотрам через священную геометрию Шри Янтры.',
    welcome2: 'Это инструмент для запоминания и усвоения, а не руководство по философии или теологии Шри Янтры или Кхадгамала Стотрам. Для этого существует множество других превосходных ресурсов, некоторые из которых перечислены на странице Ссылки.',
    h_yantra: 'Шри Янтра',
    yantra: 'Шри Янтра (также называемая Шри Чакрой) является одной из наиболее почитаемых священных геометрических мандал в индуистских, особенно в традиции Шри Видья, и буддийских тантрических традициях. Девять переплетённых треугольников — четыре направленных вверх и пять вниз — расходятся от центральной точки, Бинду, окружённые лепестками лотоса и внешним квадратным ограждением с четырьмя вратами. Вместе они образуют девять оболочек или \'покровов\' (аваран), переходя от внешнего выражения проявленной реальности к точке чистого осознания.',
    h_stotram: 'Кхадгамала Стотрам',
    stotram: 'Кхадгамала или \'Гирлянда Мечей\' Стотрам призывает по имени божеств, пребывающих в каждой из девяти аваран, двигаясь от внешней Бхупуры вовнутрь, с нарастающей тайностью, к Бинду. Девять аваран содержат 102 имени божеств. Полный стотрам также включает Ньяса Деватах, Тити Нитья Деватах, гуру Дивьяугха, Сиддхаугха и Манавауга, Нава Чакрешвари и заключительные эпитеты — всего около 160 имён, незначительно различающихся в зависимости от линии передачи. Чтение полного стотрама с ясным образом Шри Янтры в уме считается равноценным полному ритуалу Шри Чакра пуджи.',
    h_how: 'Как работает это приложение',
    how1: 'Большинство подходов к запоминанию Кхадгамала Стотрам опираются на последовательное повторение. Это приложение предлагает иной подход: пространственную память — учиться не только порядку имён, но и тому, где каждое божество пребывает в геометрии Шри Янтры. Когда геометрия подлинно усваивается, последовательное пение следует естественным образом.',
    how2: 'Работайте в разделах «Исследование» и «Запоминание» уровень за уровнем. Режим «Исследование» служит для повторения материала, а режим «Запоминание» предлагает мысленно вспомнить имя, затем навести курсор для его открытия и отметить — запомнено или нет — одним или двойным кликом. Затем проверьте своё запоминание с помощью случайных функций Location Match и «Проверка». «Карта памяти» показывает ваши сильные и слабые стороны.',
    how_drills: 'Сегментные тренировки проверяют запоминание в пределах одного сегмента янтры, Линейные тренировки — вдоль линии, пересекающей несколько кругов, а Треугольные тренировки — внутри одного из девяти основных треугольников построения янтры. Все три варианта полезны, когда раздел уже уверенно даётся в режимах «Исследование» и «Тренировка».',
    how_sync: 'Если вы используете несколько устройств, раздел «Синхронизация устройств» (внизу левой панели) позволяет переносить между ними ваш прогресс с помощью короткого кода — учётная запись, e-mail или пароль не требуются.',
    how3_pre:  'Прежде чем начать, полезно прослушать полное чтение Кхадгамала Стотрам, чтобы познакомиться со звуком и ритмом имён. Возможно, ',
    how3_link: 'эта запись',
    how3_post: ' станет хорошей отправной точкой. Надеемся, что это приложение понравится вам и окажется полезным.',
    tour_pre:  'Впервые в приложении? ',
    tour_link: 'Пройдите обзорный тур',
    tour_post: ' — краткое знакомство со всеми функциями.',
  },
  ne: {
    mantra: 'ॐ ऐं ह्रीं श्रीं ऐं क्लीं सौः',
    salut:  'नमस्त्रिपुरसुन्दरि',
    fontClass: '',
    welcome1: 'नमस्कारम् र श्री यन्त्र स्मरण सहायकमा स्वागत छ — श्री यन्त्रको पवित्र ज्यामितिद्वारा खड्गमाला स्तोत्र सिक्ने र आत्मसात् गर्ने एउटा साधन।',
    welcome2: 'यो एउटा स्मरण र आत्मसात्करण साधन हो — श्री यन्त्र वा खड्गमाला स्तोत्रको दर्शन अथवा धर्मशास्त्रको मार्गदर्शन होइन। त्यसका लागि अन्य अनेक उत्कृष्ट स्रोतहरू उपलब्ध छन्, केही सन्दर्भ पृष्ठमा सूचीबद्ध छन्।',
    h_yantra: 'श्री यन्त्र',
    yantra: 'श्री यन्त्र (श्री चक्र पनि भनिन्छ) हिन्दू, विशेषतः श्री विद्या सम्प्रदायमा, र बौद्ध तान्त्रिक परम्पराहरूमा सर्वाधिक पूजित पवित्र ज्यामितीय मण्डलहरूमध्ये एक हो। नौ अन्तर्संबद्ध त्रिभुजहरू — चार उर्ध्वमुखी र पाँच अधोमुखी — एक केन्द्रीय बिन्दुबाट विकिरण हुन्छन्, कमल दल र चार द्वारहरू भएको बाह्य वर्गाकार परिवेष्टनले घेरिएका। ती मिलेर नौ आवरणहरू बनाउँछन् — बाह्यतम व्यक्त वास्तविकताबाट शुद्ध चेतनाको बिन्दुतर्फ।',
    h_stotram: 'खड्गमाला स्तोत्र',
    stotram: 'खड्गमाला वा \'तरवारहरूको माला\' स्तोत्रले नौ आवरणहरूमा निवास गर्ने देवताहरूलाई नामसहित आह्वान गर्छ — बाह्यतम भूपुरबाट सुरु गरी, बढ्दो गोपनीयतासँग, बिन्दुसम्म। नौ आवरणहरूमा १०२ देवता नामहरू छन्। पूर्ण स्तोत्रमा न्यास देवताः, तिथिनित्य देवताः, दिव्यौघ, सिद्धौघ र मानवौघ गुरुहरू, नव चक्रेश्वरी, र समापन विशेषणहरू पनि समावेश छन् — कुल लगभग १६० नामहरू, परम्पराअनुसार केही भिन्न। श्री यन्त्रलाई मनमा स्पष्ट राखेर पूर्ण स्तोत्रको पाठ श्री चक्र पूजाको समतुल्य मानिन्छ।',
    h_how: 'यो एप कसरी काम गर्छ',
    how1: 'खड्गमाला स्तोत्र कण्ठस्थ गर्ने अधिकांश उपायहरू क्रमिक पुनरावृत्तिमा निर्भर हुन्छन्। यो एपले स्थानीय स्मृतिमा आधारित फरक दृष्टिकोण प्रस्तुत गर्छ — केवल नामहरूको क्रम मात्र होइन, बरु श्री यन्त्रको ज्यामितिमा प्रत्येक देवता कहाँ विराजमान छन् भन्ने पनि सिक्नुहोस्। ज्यामिति साँच्चिकै आत्मसात् भएपछि क्रमिक पाठ स्वाभाविक रूपमा आउँछ।',
    how2: 'अन्वेषण र कण्ठस्थ खण्डमा स्तर-दर-स्तर काम गर्नुहोस्। अन्वेषण मोड सामग्री पुनरावलोकनका लागि र कण्ठस्थ मोडमा देवताको नाम मनमा सम्झनुहोस्, त्यसपछि प्रकट गरी चिह्नित गर्नुहोस् — सही भए क्लिक, गलत भए डबल-क्लिक। Location Match र स्पट चेकले यादृच्छिक परीक्षण दिन्छन्। स्मृति नक्साले तपाईंको बल र कमजोरी देखाउँछ।',
    how_drills: 'सेग्मेन्ट ड्रिलले यन्त्रको एउटा खण्डभित्र सम्झना जाँच्छ, लाइन ड्रिलले धेरै आवरणहरू छिचोल्ने रेखाको साथमा सम्झना जाँच्छ, र त्रिकोण ड्रिलले यन्त्रका नौ मूल रचनात्मक त्रिकोणहरूमध्ये एउटाभित्र सम्झना जाँच्छ। कुनै खण्ड अन्वेषण र कण्ठस्थ मोडमा बलियो महसुस भएपछि तीनवटै प्रयास गर्न लायक छन्।',
    how_sync: 'तपाईंले धेरै उपकरणहरू प्रयोग गर्नुहुन्छ भने, बायाँ प्यानलको तल रहेको उपकरण समिकरण (Device Sync) खण्डले छोटो कोडमार्फत तपाईंको प्रगति ती उपकरणहरूबीच लैजान दिन्छ — खाता, इमेल वा पासवर्ड आवश्यक पर्दैन।',
    how3_pre:  'सुरु गर्नुभन्दा पहिले, नामहरूको ध्वनि र तालसँग परिचित हुन खड्गमाला स्तोत्रको पूर्ण पाठ सुन्नु उपयोगी हुन्छ। ',
    how3_link: 'यो रेकर्डिङ',
    how3_post: ' एक राम्रो प्रारम्भिक बिन्दु हुन सक्छ। हामीलाई आशा छ कि यो एप तपाईंका लागि उपयोगी र आनन्ददायक साबित होस्।',
    tour_pre:  'एपमा नयाँ हुनुहुन्छ? ',
    tour_link: 'निर्देशित भ्रमण गर्नुहोस्',
    tour_post: ' — सबै सुविधाहरूको छोटो परिचय।',
  },
  bn: {
    mantra: 'ওঁ ঐং হ্রীং শ্রীং ঐং ক্লীং সৌঃ',
    salut:  'নমস্ত্রিপুরসুন্দরী',
    fontClass: '',
    welcome1: 'নমস্কারম্ এবং শ্রী যন্ত্র মেমোরাইজারে স্বাগতম — শ্রী যন্ত্রের পবিত্র জ্যামিতির মাধ্যমে খড়্গমালা স্তোত্র শেখা ও আত্মস্থ করার একটি সাধন।',
    welcome2: 'এটি একটি স্মরণ ও আত্মস্থকরণ সাধন, শ্রী যন্ত্র বা খড়্গমালা স্তোত্রের দর্শন বা ধর্মতত্ত্বের নির্দেশিকা নয়। সেই উদ্দেশ্যে অনেক অন্যান্য উৎকৃষ্ট উৎস রয়েছে, কয়েকটি তথ্যসূত্র পাতায় তালিকাভুক্ত আছে।',
    h_yantra: 'শ্রী যন্ত্র',
    yantra: 'শ্রী যন্ত্র (শ্রী চক্র নামেও পরিচিত) হিন্দু, বিশেষত শ্রী বিদ্যা সম্প্রদায়ে, এবং বৌদ্ধ তান্ত্রিক ঐতিহ্যে সর্বাধিক শ্রদ্ধেয় পবিত্র জ্যামিতিক মণ্ডলগুলির মধ্যে একটি। নয়টি পরস্পর সংলগ্ন ত্রিভুজ — চারটি ঊর্ধ্বমুখী ও পাঁচটি অধোমুখী — একটি কেন্দ্রীয় বিন্দু থেকে বিকিরিত হয়, কমল পাপড়ি ও চারটি দ্বার-বিশিষ্ট বাইরের চতুর্ভুজ পরিবেষ্টনী দ্বারা ঘেরা। একত্রে এগুলি নয়টি আবরণ বা \'পর্দা\' (আবরণ) গঠন করে, প্রকটিত বাস্তবতার বাইরের প্রকাশ থেকে শুদ্ধ চেতনার বিন্দুর দিকে অগ্রসর হয়।',
    h_stotram: 'খড়্গমালা স্তোত্র',
    stotram: 'খড়্গমালা বা \'তলোয়ারের মালা\' স্তোত্র নয়টি আবরণে বিরাজমান দেবতাদের নামে আহ্বান করে — সবচেয়ে বাইরের ভূপুর থেকে শুরু করে, ক্রমবর্ধমান গোপনীয়তার সাথে, বিন্দু পর্যন্ত। নয়টি আবরণে ১০২টি দেবতার নাম রয়েছে। পূর্ণ স্তোত্রে ন্যাস দেবতাঃ, তিথি নিত্য দেবতাঃ, দিব্যৌঘ, সিদ্ধৌঘ ও মানবৌঘ গুরুগণ, নব চক্রেশ্বরী এবং সমাপনী বিশেষণসমূহও অন্তর্ভুক্ত — মোট প্রায় ১৬০টি নাম, বংশানুক্রমে সামান্য ভিন্ন। শ্রী যন্ত্র মনে স্পষ্ট রেখে পূর্ণ স্তোত্র পাঠ করা শ্রী চক্র পূজার সমতুল্য বলে বিবেচিত হয়।',
    h_how: 'এই অ্যাপটি কীভাবে কাজ করে',
    how1: 'খড়্গমালা স্তোত্র কণ্ঠস্থ করার বেশিরভাগ পদ্ধতি ক্রমিক পুনরাবৃত্তির উপর নির্ভর করে। এই অ্যাপটি স্থানিক স্মৃতির ভিত্তিতে একটি ভিন্ন পদ্ধতি প্রদান করে — শুধু নামগুলির ক্রম নয়, বরং শ্রী যন্ত্রের জ্যামিতিতে প্রতিটি দেবতা কোথায় অবস্থান করেন তাও শিখুন। যখন জ্যামিতি সত্যিকার অর্থে আত্মস্থ হয়, ক্রমিক পাঠ স্বাভাবিকভাবে অনুসরণ করে।',
    how2: 'অন্বেষণ ও কণ্ঠস্থ অনুভাগে স্তরে স্তরে কাজ করুন। অন্বেষণ মোড বিষয়বস্তু পর্যালোচনার জন্য, কণ্ঠস্থ মোডে দেবতার নাম মনে করুন, তারপর প্রকাশ করুন ও চিহ্নিত করুন — সঠিক হলে ক্লিক, ভুল হলে ডাবল-ক্লিক। Location Match ও স্পট চেক দিয়ে এলোমেলো পরীক্ষা করুন। স্মৃতি মানচিত্র আপনার শক্তি ও দুর্বলতা দেখায়।',
    how_drills: 'সেগমেন্ট ড্রিল যন্ত্রের একটি অংশের মধ্যে স্মৃতি পরীক্ষা করে, লাইন ড্রিল একাধিক আবরণ অতিক্রমকারী একটি রেখা বরাবর স্মৃতি পরীক্ষা করে, এবং ত্রিভুজ ড্রিল যন্ত্রের নয়টি মৌলিক গঠনমূলক ত্রিভুজের একটির মধ্যে স্মৃতি পরীক্ষা করে। কোনো অংশ অন্বেষণ ও মুখস্থ মোডে দৃঢ় মনে হলে তিনটিই চেষ্টা করার মতো।',
    how_sync: 'আপনি একাধিক ডিভাইস ব্যবহার করলে, বাম প্যানেলের নিচে থাকা ডিভাইস সিঙ্ক বিভাগ একটি ছোট কোডের মাধ্যমে আপনার অগ্রগতি সেগুলির মধ্যে বহন করতে দেয় — কোনো অ্যাকাউন্ট, ইমেল বা পাসওয়ার্ডের প্রয়োজন নেই।',
    how3_pre:  'শুরু করার আগে, নামগুলির শব্দ ও তাল সম্পর্কে পরিচিত হতে খড়্গমালা স্তোত্রের পূর্ণ পাঠ শোনা উপকারী। ',
    how3_link: 'এই রেকর্ডিং',
    how3_post: ' একটি ভালো শুরুর বিন্দু হতে পারে। আমরা আশা করি এই অ্যাপটি আপনার কাছে উপকারী ও আনন্দদায়ক প্রমাণিত হবে।',
    tour_pre:  'অ্যাপে নতুন? ',
    tour_link: 'নির্দেশিত ভ্রমণ করুন',
    tour_post: ' — সমস্ত বৈশিষ্ট্যের দ্রুত পরিচয়।',
  },
  ja: {
    mantra: 'Oṃ Aiṃ Hrīṃ Śrīṃ Aiṃ Klīṃ Sauḥ',
    salut:  'Namastripurasundarī',
    fontClass: 'iast',
    welcome1: 'ナマスカーラム、シュリー・ヤントラ記憶アプリへようこそ。このアプリはシュリー・ヤントラの神聖な幾何学を通じてカドガマーラー・ストートラムを学び、内なるものとして定着させるためのツールです。',
    welcome2: 'このアプリは記憶と定着のためのツールであり、シュリー・ヤントラやカドガマーラー・ストートラムの哲学・神学の解説書ではありません。その目的には他に優れた資料が多くあり、その一部は参考資料ページに掲載されています。',
    h_yantra: 'シュリー・ヤントラ',
    yantra: 'シュリー・ヤントラ（シュリー・チャクラとも呼ばれます）は、ヒンドゥー教の伝統、特にシュリー・ヴィディヤー派や仏教タントラの伝統において最も崇拝される神聖な幾何学的マンダラのひとつです。四つの上向き三角形と五つの下向き三角形、計九つの三角形が中央の点（ビンドゥ）から放射状に広がり、蓮の花びらと四つの門を持つ外側の正方形に囲まれています。これらが合わさって九つのアーヴァラナ（ヴェール）を形成し、顕現した現実の最も外側の表現から純粋な意識の点へと段階的に進んでいきます。',
    h_stotram: 'カドガマーラー・ストートラム',
    stotram: "カドガマーラーまたは「剣の花輪」ストートラムは、九つのアーヴァラナそれぞれに宿る神格を名前で召喚します。外側のブープラから始まり、秘密性を増しながら内側へ、ビンドゥへと至ります。九つのアーヴァラナには102の神格名が含まれます。完全なストートラムにはさらに、ニャーサ・デーヴァターハ、ティティ・ニティア・デーヴァターハ、ディヴィャウガ・グル、シッダウガ・グル、マーナヴァウガ・グル、ナヴァ・チャクレーシュヴァリー、そして締めの称号が含まれ、伝承によって多少の差異はありますが合計約160の名前となります。シュリー・ヤントラを心に明確に描きながら完全なストートラムを唱えることは、シュリー・チャクラ・プージャーと同等とされています。",
    h_how: 'このアプリの使い方',
    how1: 'カドガマーラー・ストートラムの記憶にあたり、多くのアプローチは順序立てた反復に頼っています。このアプリは異なるアプローチを提供します：空間記憶です。名前の順序だけを覚えるのではなく、各神格がシュリー・ヤントラの幾何学のどこに宿るかを学びます。幾何学が本当に内面化されると、順序立てた詠唱は自然に身につきます。',
    how2: '探索と記憶のセクションをアーヴァラナごとに進めてください。探索モードはコンテンツの復習に使います。記憶モードではホバー前に神格を思い出し、クリックまたはダブルクリックで記憶済みかどうかをマークします。その後、ランダムなLocation Matchとスポットチェックの機能で記憶を試してください。記憶マップは自分の強みと弱みを示してくれます。',
    how_drills: 'セグメントドリルはヤントラの一つのセグメント内での記憶を確認し、ラインドリルは複数の輪を横切るライン沿いの記憶を確認し、三角形ドリルはヤントラの9つの基礎構成三角形のうちの一つの中での記憶を確認します。セクションが探索モードと記憶モードで定着してきたら、三つとも試してみてください。',
    how_sync: '複数の端末を使う場合は、左パネル下部のデバイス同期セクションから、短いコードで進捗を端末間に引き継げます — アカウント、メール、パスワードは不要です。',
    how3_pre:  'はじめる前に、カドガマーラー・ストートラムの完全な詠唱を一度聴いて、名前の音と韻律に親しんでおくことをお勧めします。',
    how3_link: 'こちらの録音',
    how3_post: 'が良い出発点になるでしょう。このアプリがお役に立つことを願っています。',
    tour_pre:  'アプリが初めての方は、',
    tour_link: 'ガイドツアーを利用してください',
    tour_post: '。すべての機能を簡単にご紹介します。',
  },
}
