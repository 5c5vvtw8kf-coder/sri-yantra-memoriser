...
const CONTENT = {
  en: {
    ...
    how_sync: 'If you use more than one device, the Device Sync section (at the bottom of the left panel) lets you carry your progress between them with a short code — no account, email, or password required.',
