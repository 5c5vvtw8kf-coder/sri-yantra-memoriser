...
const CONTENT = {
  ...
  ne: {
    ...
    how2: 'अन्वेषण र कण्ठस्थ खण्डमा स्तर-दर-स्तर काम गर्नुहोस्। अन्वेषण मोड सामग्री पुनरावलोकनका लागि र कण्ठस्थ मोडमा देवताको नाम मनमा सम्झनुहोस्, त्यसपछि प्रकट गरी चिह्नित गर्नुहोस् — सही भए क्लिक, गलत भए डबल-क्लिक। स्पट चेकले यादृच्छिक परीक्षण दिन्छ। स्मृति नक्साले तपाईंको बल र कमजोरी देखाउँछ।',
  ...
  bn: {
    ...
    how2: 'অন্বেষণ ও কণ্ঠস্থ অনুভাগে স্তরে স্তরে কাজ করুন। অন্বেষণ মোড বিষয়বস্তু পর্যালোচনার জন্য, কণ্ঠস্থ মোডে দেবতার নাম মনে করুন, তারপর প্রকাশ করুন ও চিহ্নিত করুন — সঠিক হলে ক্লিক, ভুল হলে ডাবল-ক্লিক। স্পট চেক দিয়ে এলোমেলো পরীক্ষা করুন। স্মৃতি মানচিত্র আপনার শক্তি ও দুর্বলতা দেখায়।',
  ...
  ja: {
    ...
    how2: '探索と記憶のセクションをアーヴァラナごとに進めてください。探索モードはコンテンツの復習に使います。記憶モードではホバー前に神格を思い出し、クリックまたはダブルクリックで記憶済みかどうかをマークします。その後、ランダムなスポットチェック機能で記憶を試してください。記憶マップは自分の強みと弱みを示してくれます。',
