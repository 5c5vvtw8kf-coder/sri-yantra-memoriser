...
const CONTENT = {
  en: {
    ...
    how_drills: 'Segment Drills test recall within a single wedge of the yantra, and Line Drills test recall along a line that cuts across several circuits, both are worth trying once a section feels solid in Explore and Memorise mode.',
  ...
  'en-us': {
    ...
    how_drills: 'Segment Drills test recall within a single wedge of the yantra, and Line Drills test recall along a line that cuts across several circuits, both are worth trying once a section feels solid in Explore and Memorize mode.',
  ...
  hi: {
    ...
    how_drills: 'सेगमेंट ड्रिल श्री यन्त्र के एक खंड के भीतर स्मरण-शक्ति की जाँच करता है, और लाइन ड्रिल कई आवरणों को पार करने वाली एक रेखा के साथ स्मरण-शक्ति की जाँच करता है — जब कोई अनुभाग अन्वेषण और कंठस्थ मोड में सुदृढ़ लगे, तब दोनों आज़माने योग्य हैं।',
  ...
  kn: {
    ...
    how_drills: 'ಸೆಗ್ಮೆಂಟ್ ಡ್ರಿಲ್ ಯಂತ್ರದ ಒಂದು ವಿಭಾಗದೊಳಗೆ ನೆನಪನ್ನು ಪರೀಕ್ಷಿಸುತ್ತದೆ, ಮತ್ತು ಲೈನ್ ಡ್ರಿಲ್ ಹಲವಾರು ಆವರಣಗಳನ್ನು ದಾಟುವ ಗೆರೆಯ ಉದ್ದಕ್ಕೂ ನೆನಪನ್ನು ಪರೀಕ್ಷಿಸುತ್ತದೆ — ಒಂದು ವಿಭಾಗ ಅನ್ವೇಷಣ ಮತ್ತು ಕಂಠಸ್ಥ ಮೋಡ್‌ನಲ್ಲಿ ಭದ್ರವೆನಿಸಿದಾಗ ಎರಡನ್ನೂ ಪ್ರಯತ್ನಿಸಬಹುದು.',
  ...
  ml: {
    ...
    how_drills: 'സെഗ്മെന്റ് ഡ്രിൽ യന്ത്രത്തിന്റെ ഒരു ഭാഗത്തിനുള്ളിൽ ഓർമ്മ പരിശോധിക്കുന്നു, ലൈൻ ഡ്രിൽ പല ആവരണങ്ങളും മുറിച്ചുകടക്കുന്ന ഒരു രേഖയിലൂടെ ഓർമ്മ പരിശോധിക്കുന്നു — ഒരു വിഭാഗം പര്യവേഷണ, മനഃപ്പാഠ മോഡിൽ ഉറച്ചതായി തോന്നുമ്പോൾ രണ്ടും പരീക്ഷിക്കാവുന്നതാണ്.',
  ...
  ta: {
    ...
    how_drills: 'செக்மென்ட் டிரில் யந்த்ரத்தின் ஒரு பிரிவுக்குள் நினைவை சோதிக்கிறது, லைன் டிரில் பல ஆவரணங்களைக் கடக்கும் ஒரு கோட்டின் வழியே நினைவை சோதிக்கிறது — ஒரு பிரிவு ஆராய்வு மற்றும் மனப்பாட முறையில் உறுதியாக உணரும்போது இரண்டையும் முயற்சிக்கலாம்.',
  ...
  te: {
    ...
    how_drills: 'సెగ్మెంట్ డ్రిల్ యంత్రంలోని ఒక విభాగంలో జ్ఞాపకశక్తిని పరీక్షిస్తుంది, లైన్ డ్రిల్ అనేక ఆవరణలను దాటే లైన్ వెంట జ్ఞాపకశక్తిని పరీక్షిస్తుంది — ఒక విభాగం అన్వేషణ మరియు కంఠస్థం మోడ్‌లో స్థిరంగా అనిపించినప్పుడు రెండూ ప్రయత్నించదగినవి.',
  ...
  mr: {
    ...
    how_drills: 'सेगमेंट ड्रिल यंत्राच्या एका विभागातील स्मरणशक्ती तपासते, आणि लाइन ड्रिल अनेक आवरणे ओलांडणाऱ्या एका रेषेवरील स्मरणशक्ती तपासते — एखादा विभाग अन्वेषण आणि पाठ मोडमध्ये पक्का वाटू लागल्यावर दोन्ही करून पाहण्यासारखे आहेत.',
  ...
  gu: {
    ...
    how_drills: 'સેગમેન્ટ ડ્રિલ યન્ત્રના એક ખંડમાં સ્મરણશક્તિ ચકાસે છે, અને લાઇન ડ્રિલ અનેક આવરણોને ઓળંગતી એક રેખા પર સ્મરણશક્તિ ચકાસે છે — કોઈ વિભાગ અન્વેષણ અને કંઠસ્થ મોડમાં મજબૂત લાગે ત્યારે બંને અજમાવવા યોગ્ય છે.',
  ...
  fr: {
    ...
    how_drills: "Les Exercices de Segment testent la mémorisation au sein d'un seul segment du yantra, tandis que les Exercices de Ligne testent la mémorisation le long d'une ligne traversant plusieurs cercles — les deux sont utiles une fois qu'une section semble bien maîtrisée en mode Explorer et Mémoriser.",
  ...
  es: {
    ...
    how_drills: 'Los Ejercicios de Segmento comprueban la memorización dentro de un único segmento del yantra, y los Ejercicios de Línea la comprueban a lo largo de una línea que atraviesa varios círculos — ambos son útiles una vez que una sección se sienta sólida en el modo Explorar y Memorizar.',
  ...
  it: {
    ...
    how_drills: "Gli Esercizi di Segmento verificano la memorizzazione all'interno di un singolo segmento dello yantra, mentre gli Esercizi di Linea la verificano lungo una linea che attraversa più cerchi — entrambi sono utili una volta che una sezione appare solida in modalità Esplora e Memorizza.",
  ...
  pt: {
    ...
    how_drills: 'Os Exercícios de Segmento testam a memorização dentro de um único segmento do yantra, e os Exercícios de Linha testam-na ao longo de uma linha que atravessa vários círculos — ambos são úteis quando uma secção já parece sólida no modo Explorar e Memorizar.',
  ...
  de: {
    ...
    how_drills: 'Segmentübungen prüfen das Erinnerungsvermögen innerhalb eines einzelnen Segments des Yantra, während Linienübungen es entlang einer Linie prüfen, die mehrere Kreise durchquert — beide lohnen sich, sobald ein Abschnitt im Erkunden- und Einprägen-Modus sicher sitzt.',
  ...
  ru: {
    ...
    how_drills: 'Сегментные тренировки проверяют запоминание в пределах одного сегмента янтры, а Линейные тренировки — вдоль линии, пересекающей несколько кругов — оба варианта полезны, когда раздел уже уверенно даётся в режимах «Исследование» и «Тренировка».',
  ...
  ne: {
    ...
    how_drills: 'सेग्मेन्ट ड्रिलले यन्त्रको एउटा खण्डभित्र सम्झना जाँच्छ, र लाइन ड्रिलले धेरै आवरणहरू छिचोल्ने रेखाको साथमा सम्झना जाँच्छ — कुनै खण्ड अन्वेषण र कण्ठस्थ मोडमा बलियो महसुस भएपछि दुवै प्रयास गर्न लायक छन्।',
  ...
  bn: {
    ...
    how_drills: 'সেগমেন্ট ড্রিল যন্ত্রের একটি অংশের মধ্যে স্মৃতি পরীক্ষা করে, আর লাইন ড্রিল একাধিক আবরণ অতিক্রমকারী একটি রেখা বরাবর স্মৃতি পরীক্ষা করে — কোনো অংশ অন্বেষণ ও মুখস্থ মোডে দৃঢ় মনে হলে দুটোই চেষ্টা করার মতো।',
  ...
  ja: {
    ...
    how_drills: 'セグメントドリルはヤントラの一つのセグメント内での記憶を確認し、ラインドリルは複数の輪を横切るライン沿いの記憶を確認します — セクションが探索モードと記憶モードで定着してきたら、両方を試してみてください。',
