...
const CONTENT = {
  en: {
    ...
    how2: 'Work through the Explore and Memorise section level by level. Explore mode is there to review the content and Memorise mode to recall the focus object in your mind before hovering over it to reveal the deity and recording whether it is memorised or not, by clicking or double-clicking respectively. Then further test your recall with the random Spot Check and Location Match features. The Memory Map exists to map out your strengths and weaknesses and where to focus further efforts.',
  ...
  'en-us': {
    ...
    how2: 'Work through the Explore and Memorize section level by level. Explore mode is there to review the content and Memorize mode to recall the focus object in your mind before hovering over it to reveal the deity and recording whether it is memorized or not, by clicking or double-clicking respectively. Then further test your recall with the random Spot Check and Location Match features. The Memory Map exists to map out your strengths and weaknesses and where to focus further efforts.',
    how_drills: "Segment Drills test recall within a single wedge of the yantra, Line Drills test recall along a line that cuts across several circuits, and Triangle Drills test recall within one of the yantra's nine foundational construction triangles. All three are worth trying once a section feels solid in Explore and Memorize mode.",
    how_sync: 'If you use more than one device, e.g. desktop, laptop, mobile or iPad etc. the Device Sync section (at the bottom of the left menu panel) lets you sync your progress between them with a short code. No account, email, or password is required.',
  ...
  ta: {
    ...
    how2: 'ஆராய்ந்து மனப்பாடம் செய்யும் பிரிவில் நிலை நிலையாக செயல்படுங்கள். ஆராய்வு முறை உள்ளடக்க மதிப்பாய்வுக்கும், மனப்பாட முறையில் தேவதை பெயரை மனதில் நினைத்துப் பார்த்து வெளிப்படுத்துங்கள் — சரியெனில் கிளிக், தவறெனில் இருமுறை கிளிக். ஸ்பாட் செக் மற்றும் Location Match தோராயமான மதிப்பாய்வை வழங்குகின்றன. நினைவு வரைபடம் உங்கள் வலிமை மற்றும் பலவீனங்களை காட்டுகிறது.',
  ...
  te: {
    ...
    how2: 'అన్వేషణ మరియు కంఠస్థం విభాగంలో స్థాయి స్థాయిగా పని చేయండి. అన్వేషణ మోడ్ సమీక్షకు, కంఠస్థం మోడ్‌లో దేవతా నామం మనసులో స్మరించి బహిర్గతం చేయండి — సరైతే క్లిక్, తప్పైతే డబుల్-క్లిక్. స్పాట్ చెక్ మరియు Location Match యాదృచ్ఛిక పునరావృత్తిని అందిస్తాయి. జ్ఞాపక పటం మీ బలాలు మరియు బలహీనతలు చూపిస్తుంది.',
  ...
  mr: {
    ...
    how2: 'अन्वेषण आणि पाठ विभागात स्तर-दर-स्तर कार्य करा. अन्वेषण मोड सामग्रीच्या आढाव्यासाठी आहे आणि पाठ मोडमध्ये देवतेचे नाव मनात आठवा, नंतर प्रकट करा — बरोबर असल्यास क्लिक, चुकीचे असल्यास दुहेरी-क्लिक. स्पॉट चेक आणि Location Match यादृच्छिक पुनरावृत्ती देतात. स्मृती नकाशा तुमची बलस्थाने आणि कमकुवत बाजू दाखवतो.',
  ...
  it: {
    ...
    how2: "Lavora le sezioni Esplora e Memorizza livello per livello. La modalità Esplora serve per ripassare il contenuto, mentre la modalità Memorizza invita a richiamare mentalmente la divinità prima di rivelare il nome passando il cursore, registrando se è memorizzata o meno con un clic o doppio clic. Poi metti alla prova la tua memorizzazione con le funzioni casuali Controllo Rapido e Location Match. La Mappa della Memoria permette di visualizzare i tuoi punti di forza e di debolezza.",
  ...
  pt: {
    ...
    how2: 'Trabalhe as secções de Explorar e Memorizar nível a nível. O modo Explorar serve para rever o conteúdo e o modo Memorizar convida a recordar mentalmente a divindade antes de revelar o nome passando o cursor, registando se está memorizada ou não com um clique ou duplo clique. Depois teste a sua memorização com as funções aleatórias de Verificação Rápida e Location Match. O Mapa de Memória permite visualizar os seus pontos fortes e fracos.',
  ...
  bn: {
    ...
    how2: 'অন্বেষণ ও কণ্ঠস্থ অনুভাগে স্তরে স্তরে কাজ করুন। অন্বেষণ মোড বিষয়বস্তু পর্যালোচনার জন্য, কণ্ঠস্থ মোডে দেবতার নাম মনে করুন, তারপর প্রকাশ করুন ও চিহ্নিত করুন — সঠিক হলে ক্লিক, ভুল হলে ডাবল-ক্লিক। স্পট চেক ও Location Match দিয়ে এলোমেলো পরীক্ষা করুন। স্মৃতি মানচিত্র আপনার শক্তি ও দুর্বলতা দেখায়।',
  ...
  ja: {
    ...
    how2: '探索と記憶のセクションをアーヴァラナごとに進めてください。探索モードはコンテンツの復習に使います。記憶モードではホバー前に神格を思い出し、クリックまたはダブルクリックで記憶済みかどうかをマークします。その後、ランダムなスポットチェックとLocation Matchの機能で記憶を試してください。記憶マップは自分の強みと弱みを示してくれます。',
