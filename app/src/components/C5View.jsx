...
const c5SvaminiDeity = deities.find(d => d.sectionId === 'circuit-5' && d.role === 'chakraSvamini') ?? null
const c5YoginiDeity = deities.find(d => d.sectionId === 'circuit-5' && d.role === 'yoginiType') ?? null

const C5_TOOLTIP_OFFSET = { 1: 32, 2: 32, 6: 24, 7: 32 }
...
function Tooltip({ x, y, label, script, seq, isMobile, kana }) {
  ...
  const charW = isMobile
    ? (script === 'devanagari' ? 11.0 : script === 'bengali' ? 6.5 : script === 'telugu' ? 13 : script === 'tamil' ? 14 : script === 'kannada' ? 12.5 : script === 'malayalam' ? 13.5 : script === 'english' ? 9.0 : 8.0)
