          ...
          <div className="relative">
            ...
            {showLangMenu && (
              <div className="absolute right-0 top-8 bg-surface-800 border border-surface-600 rounded-lg shadow-xl z-50 py-1 min-w-[210px]">
                ...
                {uiLang === 'en' && (
                  <label className={`flex items-center gap-2 px-3 py-1.5 cursor-pointer hover:bg-surface-700 border-b border-surface-700
                    ${usEnglish ? 'text-gold-300' : 'text-muted'}`}>
                    <input type="checkbox" checked={usEnglish} onChange={e => setUsEnglish(e.target.checked)}
                      className="accent-amber-500 cursor-pointer" />
                    <span className="text-xs">American English</span>
                  </label>
                )}
